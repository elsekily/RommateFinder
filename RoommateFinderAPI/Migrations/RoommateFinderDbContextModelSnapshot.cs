...
namespace RoommateFinderAPI.Migrations
{
    ...
    partial class RoommateFinderDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoommateFinderAPI.Entities.Models.Room", b =>
                {
                    ...
                    b.Property<int>("NumberofPeopleintheApartment")
                        .HasColumnType("INTEGER");

                    b.Property<double>("RentPerMounth")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("RoommateFinderAPI.Entities.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RoommateFinderAPI.Entities.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoommateFinderAPI.Entities.Models.RoomTag", b =>
                {
                    b.HasOne("RoommateFinderAPI.Entities.Models.Room", "Room")
                        .WithMany("RoomTags")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoommateFinderAPI.Entities.Models.Tag", "Tag")
                        .WithMany("RoomTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
